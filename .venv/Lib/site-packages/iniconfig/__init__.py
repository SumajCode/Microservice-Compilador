...
class SectionWrapper:
    ...
    def lineof(self, name: str) -> int | None:
        return self.src.config.lineof(self.name, name)
    ...
    def get(  # type: ignore [misc]
        ...
        return self.src.config.get(self.name, key, convert=convert, default=default)

    def __getitem__(self, key: str) -> str:
        return self.src.config.sections[self.name][key]

    def __iter__(self) -> Iterator[str]:
        section: Mapping[str, str] = self.src.config.sections.get(self.name, {})

        def lineof(key: str) -> int:
            return self.src.config.lineof(self.name, key)  # type: ignore[return-value]
